...
class DavisData(Dataset):
    def __init__(self,data_root,*args,**kwargs):
        ...
        self.ratio,self.resize_w,self.resize_h = self.mask[0].shape
    ...
    def __getitem__(self,index):
        ...
        gt0,meas0 = self.gene_meas(imgs,self.mask[0])
        gt1,meas1 = self.gene_meas(imgs,self.mask[1])
        gt2,meas2 = self.gene_meas(imgs,self.mask[2])
        return gt0,meas0,meas1,meas2
    def __len__(self,):
